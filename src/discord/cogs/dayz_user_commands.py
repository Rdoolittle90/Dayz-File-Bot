...
class DayzUserCog(commands.Cog):
    ...
    async def register(self, interaction: nextcord.Interaction) -> None:
        colorize_log("INFO", f"{interaction.user.name} used DayzUserCog.register at {datetime.datetime.now()}")
        """placeholder"""
    ...
    async def profile(self, interaction: nextcord.Interaction) -> None:
        colorize_log("INFO", f"{interaction.user.name} used DayzUserCog.profile at {datetime.datetime.now()}")
        """placeholder"""
    ...
    async def atm(self, interaction: nextcord.Interaction) -> None:
        colorize_log("INFO", f"{interaction.user.name} used DayzUserCog.atm at {datetime.datetime.now()}")
        """placeholder"""
    ...
    async def inventory(self, interaction: nextcord.Interaction) -> None:
        colorize_log("INFO", f"{interaction.user.name} used DayzUserCog.inventory at {datetime.datetime.now()}")
        """placeholder"""
        embed = nextcord.Embed(title="Unavailable", color=0xff0000)
        embed.description = f"Command Coming Soon"
        await interaction.channel.send(embed=embed)
    ...
    async def trade(self, interaction: nextcord.Interaction) -> None:
        colorize_log("INFO", f"{interaction.user.name} used DayzUserCog.trade at {datetime.datetime.now()}")
        """placeholder"""
        embed = nextcord.Embed(title="Unavailable", color=0xff0000)
        embed.description = f"Command Coming Soon"
        await interaction.channel.send(embed=embed)
