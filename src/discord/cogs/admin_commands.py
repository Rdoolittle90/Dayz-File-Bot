...
from src.discord.modals.remove_map_modal import RemoveMapDropdownView, RemoveMapModal
...
class AdminCog(commands.Cog):
    ...
    async def remove_map(self, interaction: nextcord.Interaction) -> None:
        ...
        await interaction.channel.send("Select a map to remove:", view=RemoveMapDropdownView())
