...
class AdminCog(Cog):
    ...
    @SlashCommand
    @command(name="set_status", description="", default_member_permissions=8, dm_permission=False)
    ...
    @SlashCommand
    @command(name="add_map", description="", dm_permission=False)
    ...
    # =====================================================================================================
    @SlashCommand
    @command(name="load_traderconfig", description="", default_member_permissions=8, dm_permission=False)
    ...
    # =====================================================================================================
    @SlashCommand
    @command(name="kill", description="", default_member_permissions=8, dm_permission=False)
    ...
    # =====================================================================================================
    @SlashCommand
    @command(name="get_key", description="", default_member_permissions=8, dm_permission=False)
    ...
    # =====================================================================================================
    @SlashCommand
    @command(name="remove_map", description="", default_member_permissions=8, dm_permission=False)
